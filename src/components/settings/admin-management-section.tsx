...
export function AdminManagementSection({
  ...
  /** Moderators can view the roster but can't invite/remove/role-change/activate anyone — enforced server-side too. */
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {!viewerIsAdmin && (
        <p className="rounded-xl border border-dashed border-[#ececed] p-4 text-sm text-[#939393]">
          Moderators can view the admin roster but only an Admin can invite, remove, or change anyone&apos;s role or
          status.
        </p>
      )}
